...
<body>
                    ...
                    <div class="panel-body">
                        <form action="" name="form1" method="post">
                            ...
                            <div class="alert alert-danger" id="failure" style="margin-top:10px; display: none">
                                <strong>Account already exists!</strong> This usersname has already been used.
                            </div>
                        </form>
                    </div>
                </div>
    ...
    <?php
        if(isset($_POST["submit1"])){
            $count=0;
            $res = mysqli_query($link,"select * from registration where username = '$_POST[username]'") or die(mysqli_erro($link));
